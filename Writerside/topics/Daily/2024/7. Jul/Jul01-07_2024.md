...
![july07-2024-ap1-input.png](july07-2024-ap1-input.png)
...
2. **Main Loop (Merging nodes between zeros):**
   ...
   - **Iteration 3:**
      ...
      - The list is updated:
        ![july07-2024-ap1-merge1.png](july07-2024-ap1-merge1.png)
      - Move `traversal_node` to the next node
   ...
   - **Iteration 7:**
      ...
      - The traversal node is 0, triggering the merging process:
         ...
         3. Reset `current_sum` to 0
      - The list is updated:
        ![july07-2024-ap1-merge2.png](july07-2024-ap1-merge2.png)
      - Move `traversal_node` to the next node
...
![july07-2024-ap1-output.png](july07-2024-ap1-output.png)
