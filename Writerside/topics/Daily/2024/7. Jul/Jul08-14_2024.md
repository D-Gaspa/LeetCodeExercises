...
<list>
  ...
  <li>Remove substring <code>"ba"</code> and gain <code>y</code> points.
    <list>
      <li>For example, when removing <code>"ba"</code> from <code>"cabx<u>ba</u>e"</code> it becomes <code>"cxbae"</code>.</li>
    </list>
  </li>
</list>
...
<list>
  <li><b>Input:</b> <code>s = "cdbcbbaaabab", x = 4, y = 5</code></li>
  <li><b>Output:</b> 19</li>
  <li><b>Explanation:</b>
    <list>
      <li>Remove the <code>"ba"</code> underlined in <code>"cdbcbbaa<u>ab</u>ab"</code>. Now, <code>s = "cdbcbbaaab"</code> and 5 points are added to the score.</li>
      <li>Remove the <code>"ab"</code> underlined in <code>"cdbcbbaa<u>ab</u>"</code>. Now, <code>s = "cdbcbbaa"</code> and 4 points are added to the score.</li>
      <li>Remove the <code>"ba"</code> underlined in <code>"cdbcb<u>ba</u>"</code>. Now, <code>s = "cdbcba"</code> and 5 points are added to the score.</li>
      <li>Remove the <code>"ba"</code> underlined in <code>"cdbc<u>ba</u>"</code>. Now, <code>s = "cdbc"</code> and 5 points are added to the score.</li>
      <li>Total score = 5 + 4 + 5 + 5 = 19.</li>
    </list>
  </li>
</list>
