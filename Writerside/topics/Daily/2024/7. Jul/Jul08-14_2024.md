...
This technique allows for parsing complex chemical formulas
with nested structures in a single pass through the input string.
...
2. **Main Algorithm Process:**
    ...
    - **Iteration 8 (index 10):**
        ...
        - Add to previous level: `atoms_stack[-1]['S'] += 10`, `atoms_stack[-1]['O'] += 30`
