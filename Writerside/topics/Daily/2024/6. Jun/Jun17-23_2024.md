...
def maxSatisfied1(customers: List[int], grumpy: List[int], 
    ...
    grumpiness to aximize the number of additionally satisfied customers.
    This is achieved by iterating through the customers and grumpy lists,
    keeping track of the maximum number of additionally satisfied customers
    ...
    # Calculate initial normal and additional satisfaction for the first
    # 'minutes' window
