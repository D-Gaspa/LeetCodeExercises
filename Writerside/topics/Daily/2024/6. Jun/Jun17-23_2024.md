...
### Approach 1: Sliding Window {id="approach_d6_1" collapsible="true" default-state="expanded"}
...
### Approach 2: Two-Pass Counting {id="approach_d6_2" collapsible="true" default-state="collapsed"}
