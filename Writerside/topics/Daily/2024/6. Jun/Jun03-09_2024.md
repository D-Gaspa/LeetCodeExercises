...
- **Minimized Search Space:** Starting from the minimum root length and only checking up to the maximum root length (or
  word length, whichever is smaller) drastically reduces unnecessary comparisons.
