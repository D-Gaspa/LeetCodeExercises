...
### Approach 1: In-Order Traversal and Recursive Construction {id="approach_d3_1" collapsible="true" default-state="collapsed"}
...
{collapsible="true" default-state="expanded" collapsed-title="In-Order Traversal and Recursive Construction Code..."}
...
### Approach 2: Day-Stout-Warren (DSW) Algorithm {id="approach_d3_2" collapsible="true" default-state="collapsed"}
